...
##Is there a statistically significant relationship between the item an individual would bring on a 
deserted island and whether or not they like dogs?
...
##Since the p-value is 0.644 and not less than 0.05, we fail to reject the null hypothesis. There is not a statistically 
significant relationship between the item an indivudal would bring on a deserted isleand and whether or not they like dogs.
